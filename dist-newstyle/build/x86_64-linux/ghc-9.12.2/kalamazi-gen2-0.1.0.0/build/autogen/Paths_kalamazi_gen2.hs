...
-- at runtime using the environment variable kalamazi_gen2_bindir.
...
-- environment variable kalamazi_gen2_libdir.
...
-- using the environment variable kalamazi_gen2_dynlibdir.
...
-- runtime using the environment variable kalamazi_gen2_datadir.
...
-- variable kalamazi_gen2_libexedir.
...
-- using the environment variable kalamazi_gen2_sysconfdir.
...
bindir     = "/home/burtannia/.cabal/bin"
libdir     = "/home/burtannia/.cabal/lib/x86_64-linux-ghc-9.12.2-ec30/kalamazi-gen2-0.1.0.0-inplace"
dynlibdir  = "/home/burtannia/.cabal/lib/x86_64-linux-ghc-9.12.2-ec30"
datadir    = "/home/burtannia/.cabal/share/x86_64-linux-ghc-9.12.2-ec30/kalamazi-gen2-0.1.0.0"
libexecdir = "/home/burtannia/.cabal/libexec/x86_64-linux-ghc-9.12.2-ec30/kalamazi-gen2-0.1.0.0"
sysconfdir = "/home/burtannia/.cabal/etc"

getBinDir     = catchIO (getEnv "kalamazi_gen2_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "kalamazi_gen2_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "kalamazi_gen2_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "kalamazi_gen2_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "kalamazi_gen2_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "kalamazi_gen2_sysconfdir") (\_ -> return sysconfdir)
